...
function page_require_level($require_level)
{
  ...
  // Check if $current_user is an array
  if (!is_array($current_user)) {
    // Handle error - current_user() did not return an array
    // For example, you could display an error message and redirect
    $session->msg('d', 'Error: Unable to retrieve user information.');
    redirect('index.php', false);
  }

  // Check if 'user_level' key exists in $current_user array
  if (!isset($current_user['user_level'])) {
    // Handle error - 'user_level' key not found in $current_user
    // For example, you could display an error message and redirect
    $session->msg('d', 'Error: User level not found.');
    redirect('index.php', false);
  }
